...
namespace Crawler.DBAccess
{
    public static class MySqlHelper
    {
        #region 变量
        internal static MySqlConnection _MySqlConnection = null;
        #endregion
        ...
        public static MySqlConnection MySqlConnection
        {
            get
            {
                if (MySqlHelper._MySqlConnection == null)
                {
                    MySqlHelper._MySqlConnection = new MySqlConnection();
                }
                if (string.IsNullOrWhiteSpace(MySqlHelper._MySqlConnection.ConnectionString))
                {
                    MySqlHelper._MySqlConnection.ConnectionString = Conn.ConnectionString;
                }
                if (MySqlHelper._MySqlConnection.State != ConnectionState.Open)
                    MySqlHelper._MySqlConnection.Open();
                return MySqlHelper._MySqlConnection;
            }
            set { MySqlHelper._MySqlConnection = value; }
        }
        #endregion
